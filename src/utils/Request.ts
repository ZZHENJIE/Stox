...
export async function Kimi_Create_QRCode() {
...
export async function Kimi_QRCode_Status(id: string) {
...
export async function Kimi_Chat_List(token: string, offset: number = 0, size: number = 5) {
...
export async function Kimi_Chat_Content(chat_id: string, token: string, last: number = 50) {
...
export async function Kimi_Create_Chat(token: string, chat_name: string = 'new chat') {
